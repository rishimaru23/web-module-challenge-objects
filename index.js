...
function createMenuItem(name, price, category){ //invoking the function
...
function newRating(array, name, rating, feedback){
  array.push({name, name, rating, feedback});
  return array;
}
console.log (newRating(reviews, 'Ryan', 5, 'Great and fun atmosphere'));

reviews.push ({
  name: 'Ryan',
  rating: 5,
  feedback: 'Great and fun atmosphere'
}
)
